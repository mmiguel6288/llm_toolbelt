...
import llm_toolbelt as m

import pytest
from llm_toolbelt import Toolbelt, APIOMORPHIC_AVAILABLE
import asyncio
from typing import List, Dict

def test_version():
    assert importlib.metadata.version("llm_toolbelt") == m.__version__
...
@pytest.mark.skipif(not APIOMORPHIC_AVAILABLE,
                    reason="apiomorphic not installed")
